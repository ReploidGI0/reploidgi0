...
Date: 11/12/2021
Description: Programa que simula el rompecabezas de la torre de hanoi, pero esta segunda versión
permite al usuario introducir el número de discos a mover
Input: Disk
Output: Move disk from n to n
*/
